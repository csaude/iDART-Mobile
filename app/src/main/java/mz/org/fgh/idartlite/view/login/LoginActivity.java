...
public class LoginActivity extends BaseActivity implements RestResponseListener<Clinic> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.displayImportantMessage(this,"Ao acessar este sistema," +
                ...
                " É sua responsabilidade protegê-las adequadamente e usá-las somente para os fins autorizados. A privacidade dos utentes é essencial para a nossa missão.","Aviso de Confidencialidade").show();
    }
